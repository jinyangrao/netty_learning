package com.mylearn.proto.grpcclient;

import com.mylearn.proto.*;
import com.mylearn.protobuf.DataInfo;
...
public class GrpcClient {
    public static void main(String[] args) {
       ...
       MyResponse myResponse =  blockingStub.getRealNameByUsername(
        ...
        Iterator<StudentResponse> itor = blockingStub.getStudentByAge(StudentRequest.newBuilder().setAge(20).build());


        while(itor.hasNext()) {

            StudentResponse studentResponse = itor.next();
